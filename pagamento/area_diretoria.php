          ...
          if ($result->num_rows > 0) {         
            while($row = $result->fetch_assoc()) {     
              if($row['aprovacao5'] == 5){                
                  ...
                  echo "<th><a type='button' class='btn btn-dark' href='visualizar_area_solicitante_diretoria.php?id_solicitacao=". $row['id_solicitacao']."'>Visualizar</a></th></tr>";
