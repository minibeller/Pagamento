...
WHERE a.aprovacao5 = 'Sim' OR a.aprovacao5 = 'OK';";
...
<div class='row' style="width: 100%;">
    ...
    <div class='col-10'>
        ...
        <div class='row'>
          <div class='col-6'>
            <nav aria-label="...">
              <ul class="pagination ">
                <li class="page-item">
                    <a class="page-link" href="area_diretoria.php" tabindex="-1">Não Aprovada</a>
                    </li>
                    <li class="page-item"><a class="page-link" href="area_diretoria_aprovadas.php">Aprovada</a></li>
                    <li class="page-item"><a class="page-link" href="area_diretoria_nao_aprovadas.php">Não Autorizada</a>
                </li>
              </ul>
            </nav>
      ...
      <div class="badge bg-dark" style="width: 100%;">
        ...
        <h1>Área Diretoria Aprovadas.</h1>
      </div>      
          ...
          if ($result->num_rows > 0) {         
            while($row = $result->fetch_assoc()) { 
              ...
              elseif($row['aprovacao5'] == 'nao_autorizada'){        
                ...
                echo "<th><a  type='button' class='btn btn-dark' href='visualizar_area_solicitante_aprovadas_diretoria.php?id_solicitacao=". $row['id_solicitacao']."'>Visualizar</a></th></tr>";
              }         
