          ...
          if ($result->num_rows > 0) {         
            while($row = $result->fetch_assoc()) {     
              if($row['aprovacao0'] == 0){                
                  ...
                  echo "<th><a type='button' class='btn btn-dark' href='visualizar_area_solicitante_financeiro.php?id_solicitacao=". $row['id_solicitacao']."'>Visualizar</a></th></tr>";
