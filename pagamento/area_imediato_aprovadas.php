...
WHERE a.aprovacao1 = 'OK' OR a.aprovacao1 = 'Sim';";
...
<div class='row' style="width: 100%;">
    ...
    <div class='col-10'>
        ...
        <div class='row'>
          <div class='col-6'>
            <nav aria-label="...">
              <ul class="pagination ">
                <li class="page-item">
                    <a class="page-link" href="area_imediato.php" tabindex="-1">Não Aprovada</a>
                    </li>
                    <li class="page-item"><a class="page-link" href="area_imediato_aprovadas.php">Aprovada</a></li>
                    <li class="page-item"><a class="page-link" href="area_imediato_nao_aprovadas.php">Não Autorizada</a>
                </li>
              </ul>
            </nav>
      ...
      <div class="badge bg-dark" style="width: 100%;">
        ...
        <h1>Área do Supervisor Imediato Aprovadas.</h1>
      </div>      
          ...
          if ($result->num_rows > 0) {         
            while($row = $result->fetch_assoc()) { 
              ...
              elseif($row['aprovacao5'] == 'nao_autorizada'){        
                ...
                echo "<tr class='table-success'>  <th scope='row'>". $row['numero_protocolo']."</th>" ;
                ...
                echo "<th><a  type='button' class='btn btn-dark' href='visualizar_area_solicitante_aprovadas_imediato.php?id_solicitacao=". $row['id_solicitacao']."'>Visualizar</a></th></tr>";
              }         
