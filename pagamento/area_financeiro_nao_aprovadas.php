  ...
  <div class='row' style="width: 100%;">
      ...
      <div class='col-10'>
          ...
          <div class="badge bg-dark" style="width: 100%;">
              ...
              <h1>Área do Financeiro Não Aprovadas.</h1>
          </div>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            if ($row['aprovacao0'] == 'nao_autorizada') {
                                ...
                                echo "<th><a type='button' class='btn btn-dark' href='visualizar_area_financeiro_nao_aprovada.php?id_solicitacao=" . $row['id_solicitacao'] . "'>Visualizar</a></th></tr>";
