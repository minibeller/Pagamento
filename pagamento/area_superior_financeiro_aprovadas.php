...
WHERE a.aprovacao4 = 'Sim' OR a.aprovacao4 = 'OK';";
...
<div class='row' style="width: 100%;">
    ...
    <div class='col-10'>
      ...
      <div class="badge bg-dark" style="width: 100%;">
        ...
        <h1>Área do Superior Financeiro Aprovadas.</h1>
      </div>      
          ...
          if ($result->num_rows > 0) {         
            while($row = $result->fetch_assoc()) { 
              ...
              elseif($row['aprovacao5'] == 'nao_autorizada'){        
                ...
                echo "<th><a  type='button' class='btn btn-dark' href='visualizar_area_solicitante_aprovadas_superior_financeiro.php?id_solicitacao=". $row['id_solicitacao']."'>Visualizar</a></th></tr>";
              }         
