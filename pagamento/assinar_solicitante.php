...
<body class="text-center">
    <div class="row" style="width: 100%;">
        ...
        <div class="col-sm text-center">
                ...
                <form method="POST" action="aprovar_solicitante.php" class="form-signin">
                    ...
                    <button class="btn mt-3 text-white btn-success btn-lg btn-block" style="width: 100%;" type="submit">Assinar</button>
                </form>
            </div>
        </div>
        <div class="col-4"></div>
